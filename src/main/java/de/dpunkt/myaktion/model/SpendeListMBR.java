...
public class SpendeListMBR implements MessageBodyReader<List<Spende>> {
	...
	@Override
	public List<Spende> readFrom(Class<List<Spende>> c, Type t, Annotation[] ann, MediaType mt,
			MultivaluedMap<String, String> mm, InputStream is) throws IOException, WebApplicationException {
